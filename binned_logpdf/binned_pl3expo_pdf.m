...
%         expo_term3=(1-a1-a2)*(gamma_incomplete(lam3*l,1-alpha)-gamma_incomplete(lam3*u,1-alpha))./(gamma_incomplete(lam3*xmin,1-alpha));
        ...
        expo_term3=(1-a1-a2)*(gamma_incomplete(lam3*l,1-alpha)-gamma_incomplete(lam3*u,1-alpha))./(gamma_incomplete(lam3*xmin,1-alpha)-gamma_incomplete(lam3*xmax,1-alpha));
