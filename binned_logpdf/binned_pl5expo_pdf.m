...
%         expo_term5=(1-a1-a2-a3-a4)*(gamma_incomplete(lam5*l,1-alpha)-gamma_incomplete(lam5*u,1-alpha))./(gamma_incomplete(lam5*xmin,1-alpha));
        ...
        expo_term5=(1-a1-a2-a3-a4)*(gamma_incomplete(lam5*l,1-alpha)-gamma_incomplete(lam5*u,1-alpha))./(gamma_incomplete(lam5*xmin,1-alpha)-gamma_incomplete(lam5*xmax,1-alpha));
