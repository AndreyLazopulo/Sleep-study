function [output,errors,r2]=loghistfit4(data,step,n,NtMax,zerorem,plotting,bintype)
...
switch n
    case 1
        g=@(l1,x)(l1*exp(-l1*exp(x))./(exp(-l1*xmin)-exp(-l1*xmax))).*exp(x);
    case 2
        g=@(a1,l1,l2,x)(a1*l1*exp(-l1*exp(x))./(exp(-l1*xmin)-exp(-l1*xmax))+(1-a1)*l2*exp(-l2*exp(x))./(exp(-l2*xmin)-exp(-l2*xmax))).*exp(x);
    case 3
        g=@(a1,a2,l1,l2,l3,x)(a1*l1*exp(-l1*exp(x))./(exp(-l1*xmin)-exp(-l1*xmax))+a2*l2*exp(-l2*exp(x))./(exp(-l2*xmin)-exp(-l2*xmax))+(1-a1-a2)*l3*exp(-l3*exp(x))./(exp(-l3*xmin)-exp(-l3*xmax))).*exp(x);
    case 4
        g=@(a1,a2,a3,l1,l2,l3,l4,x)(a1*l1*exp(-l1*exp(x))./(exp(-l1*xmin)-exp(-l1*xmax))+a2*l2*exp(-l2*exp(x))./(exp(-l2*xmin)-exp(-l2*xmax))+a3*l3*exp(-l3*exp(x))./(exp(-l3*xmin)-exp(-l3*xmax))+(1-a1-a2-a3)*l4*exp(-l4*exp(x))./(exp(-l4*xmin)-exp(-l4*xmax))).*exp(x);
    case 5
        g=@(a1,a2,a3,a4,l1,l2,l3,l4,l5,x)(a1*l1*exp(-l1*exp(x))./(exp(-l1*xmin)-exp(-l1*xmax))+a2*l2*exp(-l2*exp(x))./(exp(-l2*xmin)-exp(-l2*xmax))+a3*l3*exp(-l3*exp(x))./(exp(-l3*xmin)-exp(-l3*xmax))...
            +a4*l4*exp(-l4*exp(x))./(exp(-l4*xmin)-exp(-l4*xmax))+(1-a1-a2-a3-a4)*l5*exp(-l5*exp(x))./(exp(-l5*xmin)-exp(-l5*xmax))).*exp(x);
    case 6
        g=@(a1,a2,a3,a4,a5,l1,l2,l3,l4,l5,l6,x)(a1*l1*exp(-l1*exp(x))./(exp(-l1*xmin)-exp(-l1*xmax))+a2*l2*exp(-l2*exp(x))./(exp(-l2*xmin)-exp(-l2*xmax))+a3*l3*exp(-l3*exp(x))./(exp(-l3*xmin)-exp(-l3*xmax))...
...
lb=[repmat(-1,1,n-1),zeros(1,n)];
ub=[repmat(1,1,n-1),10*ones(1,n)];
...
if plotting == 1
    ...
    switch n
        ...
        case 2
            plot(fitX,g(parms(1,1),parms(1,2),parms(1,3),fitX).*diff(edges),'r')
        case 3
            plot(fitX,g(parms(1,1),parms(1,2),parms(1,3),parms(1,4),parms(1,5),fitX).*diff(edges),'r')
        case 4
            plot(fitX,g(parms(1,1),parms(1,2),parms(1,3),parms(1,4),parms(1,5),parms(1,6),parms(1,7),fitX).*diff(edges),'r')
        case 5
            plot(fitX,g(parms(1,1),parms(1,2),parms(1,3),parms(1,4),parms(1,5),parms(1,6),parms(1,7),parms(1,8),parms(1,9),fitX).*diff(edges),'r')
        case 6
            plot(fitX,g(parms(1,1),parms(1,2),parms(1,3),parms(1,4),parms(1,5),parms(1,6),parms(1,7),parms(1,8),parms(1,9),parms(1,10),parms(1,11),fitX).*diff(edges),'r')
    end
end
output=parms(1:40,:);
end
