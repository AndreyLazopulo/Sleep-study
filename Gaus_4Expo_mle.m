...
lowerbound=[miny miny miny miny 0 1 log(minlambda) log(minlambda) log(minlambda) log(minlambda)];
upperbound=[maxy maxy maxy maxy Inf Inf log(maxlambda) log(maxlambda) log(maxlambda) log(maxlambda)];
